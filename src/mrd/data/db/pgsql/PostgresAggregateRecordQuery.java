 ...
 * @author mrdlap
 */
public class PostgresAggregateRecordQuery extends AggregateRecordQuery {

    public PostgresAggregateRecordQuery(PostgresConnection conn, AggregateRecord record, AbstractFilter recordFilter, AbstractFilter aggregateFilter) {
